                          ...
                          children: [
                            Expanded(
                              child: MotivationWidget(
                                ...
                                showOrHide: () {
                                  setState(() {
                                    state.data.boolFalse[index] = !state.data.boolFalse[index];
                                  });
                                },
                            ...
                            Expanded(
                              child: MotivationWidget(
                                ...
                                showOrHide: () {
                                  setState(() {
                                    state.data.boolFalse[index + 1] = !state.data.boolFalse[index + 1];
                                  });
                                },
                          ...
                          children: [
                            Expanded(
                              child: MotivationWidget(
                                ...
                                showOrHide: () {
                                  setState(() {
                                    state.data.boolFalse[index + 2] = !state.data.boolFalse[index + 2];
                                  });
                                },
                            ...
                            Expanded(
                              child: MotivationWidget(
                                ...
                                showOrHide: () {
                                  setState(() {
                                    state.data.boolFalse[index + 3] = !state.data.boolFalse[index + 3];
                                  });
                                },
